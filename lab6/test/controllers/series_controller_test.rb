...
class SeriesControllerTest < ActionController::TestCase
  ...
  test "should create series" do
    assert_difference('Series.count') do
      post :create, series: { end_date: @series.end_date, start_date: @series.start_date, title: @series.title }
    end
  ...
  test "should update series" do
    patch :update, id: @series, series: { end_date: @series.end_date, start_date: @series.start_date, title: @series.title }
    assert_redirected_to series_path(assigns(:series))
  end
